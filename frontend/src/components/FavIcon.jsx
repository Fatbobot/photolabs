...
const FavIcon = ({ displayAlert, selected }) => {
  ...
  return (
    <svg width="20" height="17" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Render the heart shape with a fill color based on whether it's selected */}
      <path 
      ...
      {/* Conditionally render the alert circle if displayAlert is true */}
      {!!displayAlert && (
        <circle 
          cx="21" 
          cy="4" 
...
// Export the FavIcon component as the default export
